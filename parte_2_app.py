...
page = st_navbar(["Inicio", "Grafos y Centralidad", "AuthorRank", "ABCD"])
...
if page == "Inicio":
        ...
        intro  = st.markdown(
            '''
            **Grafos y Centralidades**

            En esta sección, se presentan brevemente los conceptos de grafos y centralidad, incluyendo ejemplos de los diferentes tipos de grafos, las tres centralidades típicas en el análisis y, finalmente, el algoritmo de PageRank.

            **Aplicación de AuthorRank**

            En esta sección, se aplica el algoritmo de AuthorRank y se muestran los resultados obtenidos.

            **Aplicación del algoritmo de comunidades ABCD**

            En esta última sección, se aplica el algoritmo de comunidades ABCD.
...
# Mostrar contenedores según el botón seleccionado
elif page == "Grafos y Centralidad":
