...
- [Algoritmo de AuthorRank con más detalles](https://algoritmo-a-uthorrank.streamlit.app/) 

- [Algoritmo de comunidades ABCD](https://algoritmo-comunidades-abcd.streamlit.app/) 

- [Parte 1 de mi memoria de título](https://bibliometria-dashboard.streamlit.app/)                   
''', unsafe_allow_html=True)


st.header("""Análisis de Redes Sociales: Una Herramienta para Entender la Estructura de la Comunidad Científica
...
### ¿Por qué realizar un análisis de redes sociales?

*   **Identificar patrones de colaboración**: Reconocer la influencia de diferentes actores en el campo.
*   **Comprender la estructura de la red de coautoría**: Cómo se relacionan los autores entre sí.
*   **Obtener insights valiosos**: Sobre la dinámica de la investigación en psicología en Chile.
*   **Identificar oportunidades de colaboración**: Reconocer la contribución de diferentes autores al campo.

### Objetivo

Realizar un análisis de redes sociales para entender la estructura de la comunidad científica en psicología en Chile, identificar patrones de colaboración y reconocer la influencia de diferentes actores en el campo.
            '''
        )
